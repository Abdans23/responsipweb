...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="index.html"><strong>Rumah</strong> Makan Enak</a>
      ...
      <div class="container">
        <div class="row mt-3">
         ...
         <div class="row mt-3 mb-5">
          <div class="col-md-3">
            <div class="card border-dark">
              <img src="images/aqua.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title font-weight-bold">Air Putih Aqua</h5>
                <label class="card-text">Rp. 5.000</label><br>
              </div>
            </div>
          </div>  
